...
R"()"
  ...
  const Ini::Document doc1 = Ini::Load(input1);
...
std::istringstream input4(
  ...
  const Ini::Document doc2 = Ini::Load(input2);
  const Ini::Document doc3 = Ini::Load(input3);
  const Ini::Document doc4 = Ini::Load(input4);
}
int main() {
  TestRunner tr;
